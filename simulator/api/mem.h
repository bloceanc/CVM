...
extern bucket_t *pool_create(unsigned char *addr, size_t size);
extern void *pool_malloc(bucket_t *bds, size_t size);
extern void pool_free(bucket_t *bds, void *addr);
